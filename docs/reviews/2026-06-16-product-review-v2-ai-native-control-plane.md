...
1. `docs/product/ai-native-control-plane-charter.md` を追加する。
2. `docs/architecture/ai-action-approval-model.md` を追加する。
3. `docs/architecture/intent-plan-run-lifecycle.md` を追加する。
4. ADR 0002 として AI action approval boundary を提案する。
